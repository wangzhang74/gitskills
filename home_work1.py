# -*- coding: utf-8 -*-
"""
Created on Fri Nov  2 13:58:20 2018
...
#y=beta0+beta1*x1+beta2*x2+w  beta0=0.4,beta1=0.7,beta2=0.7,x1=3u,x2=3v
lt_beta0 = []
lt_beta1 = []
lt_beta2 = []
...
for i in range(1000):
    ...
    axis1.text(-6,5.5,'a0=%.8f'%x1_beta0,fontsize=3)
    axis1.text(-6,5.0,'a1=%.8f'%x1_beta1,fontsize=3)
    axis1.text(-6,4.5,'r_X1_and_Y=%.8f'%r_x1y,fontsize=3)
    ...
    axis2.text(5.0,-5.5,'b0=%.8f'%x2_beta0,fontsize=3)
    axis2.text(5.0,-5.0,'b1=%.8f'%x2_beta1,fontsize=3)
    axis2.text(5.0,-4.5,'r_X2_and_Y=%.8f'%r_x2y,fontsize=3)
    ...
    #plt.savefig(r'C:\Users\Administrator\Desktop\home work for economitrics\work2_fig%d'%i,dpi=400,bbox_inches='tight')
    
#beta(0,1,2)的方差列表
print('list of segam_beta0_squared is:'+str(lt_segam_beta0_squared),
      'list of segam_beta1_squared is:'+str(lt_segam_beta1_squared),
      'list of segam_beta2_squared is:'+str(lt_segam_beta2_squared))
'''save_excel = pd.ExcelWriter(r'C:\Users\Administrator\Desktop\home work for economitrics\data1.xlsx')
data= {'segam_beta0_squared':lt_segam_beta0_squared,'segam_beta1_squared':lt_segam_beta1_squared,'segam_beta2_squared':lt_segam_beta2_squared}
